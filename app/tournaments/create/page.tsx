                ...
                onSubmit={(e) => {
                  ...
                  const handleTournamentCreation = async () => {
                    try {
                      ...
                      console.log("[v0] Authenticated user:", authenticatedUser.id)
                      ...
                      if (!dbUser) {
                        ...
                        const { data: newUser } = await supabase
                          ...
                          .insert({
                            ...
                            username: userName,
                            email: userEmail || "",
                            display_name: authenticatedUser.user_metadata?.display_name || userName,
                            elo_rating: 1200,
                          })
                          .select()
                          .single()
                      ...
                      const { monthLongTournamentService } = await import(
                        "@/lib/services/month-long-tournament-service"
                      )
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-2">
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        {hasConflict ? (
                          <div className="text-destructive font-medium">
                            ⚠️ <strong>CONFLICT:</strong> Need {playersNeeded} players but only{" "}
