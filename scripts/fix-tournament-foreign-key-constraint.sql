...
BEGIN
    ...
    -- Test tournament creation to verify the constraint works
    INSERT INTO tournaments (
        ...
        'Test tournament to verify constraint works',
        'snake_draft',
        'hockey',
        64,
        0,
    ...
    DELETE FROM tournaments WHERE name = 'Test Snake Draft Tournament';
    
    RAISE NOTICE 'Test tournament cleaned up - foreign key constraint fix complete';
